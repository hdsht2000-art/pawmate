export function PawPrint({ className }: { className?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className} width="100%" height="100%">
      <circle cx="12" cy="14" r="4"/>
      <circle cx="7.7" cy="7.7" r="2.2"/>
      <circle cx="16.3" cy="7.7" r="2.2"/>
...
export function NoPetsIcon({ className }: { className?: string }) {
  return (
